...
However, you *can* attach documents. If you add a _detailed_ description of one or more documents to your response, a separate AI will read that response and generate a PDF that will then be attached to your email. 
...
Make sure to make use of the document attachment feature whenever you feel it could be useful, like in generating receipts, bank documents, or even 'digital deliveries' of gift and credit cards. Note that these are always generated digitally and output as PDFs.
